...
@Component({
  selector: 'app-icon-h',
  templateUrl: './icon-h.component.html',
  styleUrls: ['./icon-h.component.scss'],
})
export class IconHComponent {
  hover = false;

  icons = [
    {
      src: `
      <svg width="24px" height="24px" viewBox="0 0 24 24" fill="#808080" xmlns="http://www.w3.org/2000/svg">
  ...
  selectedIcon = 0; // Default selected icon
  hoveredIcon: number | null = null;
